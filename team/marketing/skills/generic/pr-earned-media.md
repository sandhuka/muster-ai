...
- One-page summary (PDF): app name, tagline, description, 3 differentiators, pricing, App Store link
- Hi-res screenshots (no device frames), app icon (1024x1024), founder headshot + bio
- Key stats (downloads, rating, beta satisfaction). Demo video (unlisted YouTube)
...
**Follow-up**: Once, after 5 business days. Brief. If no response, move on.

**Embargo**: Offer to 1-2 Tier 1-2 outlets for exclusive early access. Trade exclusivity for coverage commitment.

## Thought Leadership

| Activity | When | Investment |
|----------|------|-----------|
| Building-in-public (Twitter/X threads) | Ongoing from pre-launch | 1 hr/week |
| Blog posts (product blog or Medium) | Monthly | 2-3 hrs/post |
...
| Stage | Strategy | Time |
|-------|----------|------|
| Pre-launch | Press list, relationships, kit creation | 5 hrs total |
| Launch week | Embargo pitches, Product Hunt, coordinated outreach | 10-15 hrs (burst) |
| Months 1-3 | Follow up with traction data, Tier 3 outreach | 2 hrs/month |
| Months 3-6 | Milestone pitches ("10K downloads"), Tier 2 re-pitch | 2-3 hrs/month |
| 6-12 months | Thought leadership, speaking, annual roundups | 3-4 hrs/month |