...
### Pre-Season (2 Weeks Before Peak)
Update ASO keywords for season. Create season-specific ad creatives (Content + UI/UX agents). Brief creators on seasonal messaging. Draft email sequences. Set paid budgets. Schedule social content.

### Peak Window (1-4 Weeks)
Launch all channels simultaneously. Daily monitoring (30 min). Respond within 2 hours. Mid-campaign: reallocate budget toward best channel.

### Post-Season (1 Week After)
Pull metrics. Complete post-mortem (see `campaign-playbook.md`). Archive creative. Log learnings.

## Black Friday Strategy
The ONE planned promotion per year. More frequent discounting trains users to wait.

- **Discount**: 30-40% off annual subscription only. Never monthly. Never >40%. Never "free"
- **Duration**: Black Friday through Cyber Monday (4-5 days). Do not extend — scarcity must be real
